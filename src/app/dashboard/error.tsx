...
export default function DashboardError({
    ...
    const [showDetails, setShowDetails] = useState(true); // Always show by default for debugging
            ...
            <div className="max-w-lg text-center space-y-6">
                ...
                <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground">
                        An error occurred while loading this page. The error details below can help diagnose the issue.
                    </p>
                </div>
