...
const UPSC_SUBJECTS = [
  { name: 'Polity', icon: '⚖️', color: 'bg-blue-500/10 text-blue-600 border-blue-500/20' },
  ...
  { name: 'Science & Technology', icon: '🔬', color: 'bg-purple-500/10 text-purple-600 border-purple-500/20' },
...
export default function NewQuizPage() {
  ...
  const [subject, setSubject] = useState(searchParams.get('subject') || 'Polity');
  ...
  return (
    <div className="min-h-screen pb-12">
      ...
      <header className="sticky top-0 z-30 flex items-center justify-between px-4 py-4 bg-background/80 backdrop-blur-md border-b border-border/50">
        <Link href="/dashboard/quiz" className="p-2 -ml-2 rounded-full hover:bg-muted transition-colors">
