    ...
    <BentoGrid className="grid-cols-1 md:grid-cols-3 auto-rows-[minmax(200px,auto)]">
      ...
      <div className="md:row-span-2 bento-card bg-gradient-to-b from-secondary/10 to-card p-6 flex flex-col">
        ...
        <div className="space-y-3 mt-auto">
          <Link href="/quiz/history-5" className="flex items-center gap-3 p-3 rounded-2xl bg-muted/30 hover:bg-muted/50 transition-colors cursor-pointer border border-transparent hover:border-border/50">
      ...
      >
        ...
        <div className="space-y-4">
          <Link href="/current-affairs/1" className="flex gap-4 items-start group/item cursor-pointer">
          ...
          <Link href="/current-affairs/2" className="flex gap-4 items-start group/item cursor-pointer">
